...
| Expected folder has matching marker | Open immediately; do not scan elsewhere. Warn if additional UUID markers coexist. | None. | [ADR-0025](../adr/0025-active-note-open-recovery-scan.md), [ADR-0027](../adr/0027-uuid-named-marker-files.md) |
...
| Exact-name candidate has malformed marker filename or legacy payload | Display-only. | Show malformed status; do not offer overwrite/adoption. Canonical marker content is not read. | [ADR-0009](../adr/0009-status-model.md), [ADR-0027](../adr/0027-uuid-named-marker-files.md), [ADR-0025](../adr/0025-active-note-open-recovery-scan.md) |

...
| [ADR-0021](0021-obsidian-cli-integration-testing.md) | Accepted | 2026-03-03 | Require Obsidian CLI Integration Testing (v1.12+) | `testing`, `tooling` | Before adding or changing test strategy and fixtures. |
